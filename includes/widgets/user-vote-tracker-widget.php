...
<p>
  ...
  <input type="text" class="widefat" id="<?php echo $this->get_field_id('uvt_no_of_post') ?>"
    name="<?php echo $this->get_field_name('uvt_no_of_post') ?>" value="<?php echo esc_attr($uvt_no_of_post) ?>" />
</p>

<!-- Display Front Pagination  -->
<p>
  <label for="<?php echo $this->get_field_id('uvt_pagination'); ?>"><?php _e('Display Pagination', 'bpvm_wpva'); ?>:
  </label>
...
<p>
  <label for="<?php echo $this->get_field_id('uvt_hide_meta'); ?>"><?php _e('Hide Meta Information', 'bpvm_wpva'); ?>:
  </label>
...
<p>
  <label for="<?php echo $this->get_field_id('uvt_global_mode'); ?>"><?php _e('Enable Global Mode', 'bpvm_wpva'); ?>:
  </label>
