...
<div class="wrap bpvm-filter-wrapper" id="uvt_voting_report_page">
    ...
    <h2><?php esc_html_e("My Voting Report:", "bpvm_uvt"); ?><span id="bpvm-admin-loader" class="dn"><?php esc_html_e("Processing....", "bpvm_uvt"); ?></span></h2>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <table>
                <tr style="text-align: center;">
                    ...
                    <td style="width: 40%;"><?php esc_html_e("Custom Date Range :", "bpvm_uvt"); ?> <input type="checkbox" id="uvt_custom_date_range" />
                        <span class="report-break"></span>
                ...
                <tr>
                    <td colspan="9" style="text-align:center;">
                        ...
                        <input type="button" name="mv_uvt_go" id="mv_uvt_go" value="<?php esc_html_e("Generate Report", "bpvm_uvt"); ?>" class="button button-primary button-large" />
                    </td>
                </tr>
            </table>
